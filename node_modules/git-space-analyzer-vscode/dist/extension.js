...
const core_1 = require("@git-space-analyzer/core");
const provider_1 = require("./provider");
function activate(context) {
    console.log('Git Space Analyzer extension is now active!');
    // Register the tree data provider
    const provider = new provider_1.GitSpaceAnalyzerProvider(context);
    vscode.window.registerTreeDataProvider('gitSpaceAnalyzer', provider);
    // Register commands
    const analyzeCommand = vscode.commands.registerCommand('gitSpaceAnalyzer.analyze', async (uri) => {
        ...
        try {
            await vscode.window.withProgress({
                ...
                const analyzer = new core_1.GitSpaceAnalyzer(repositoryPath);
    ...
    const showReportCommand = vscode.commands.registerCommand('gitSpaceAnalyzer.showReport', () => {
        const panel = vscode.window.createWebviewPanel('gitSpaceAnalyzerReport', 'Git Space Analysis Report', vscode.ViewColumn.One, {
            enableScripts: true,
